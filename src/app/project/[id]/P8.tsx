    ...
    return (
        <>
            ...
            <div className='md:w-8/12 px-8 md:px-0 mx-auto'>
                ...
                {/* Title */}
                <h1 className='mt-8 md:text-5xl text-3xl  text-white' style={{ fontFamily: 'Baskervville SC, serif' }}>Smart Electrifying Agriculture Integrated with IoT Through the Implementation of the Quine-McCluskey Algorithm</h1>
                <h2 className='md:text-lg text-sm my-4 font-mono text-white'>Innovillage 2022 Funding Awardee | Telkom Indonesia</h2>
                <h2 className='md:text-lg text-sm my-4 font-mono text-white'>Top 10 Innovation Green Technopreneur Competition PFSains 2022 | Pertamina Foundation</h2>
                {/* Video */}
                <iframe

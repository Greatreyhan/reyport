    ...
    return (
        <>
            ...
            <div className='md:w-8/12 px-8 md:px-0 mx-auto'>
                ...
                {/* Title */}
                <h1 className='mt-8 md:text-5xl text-3xl  text-white' style={{ fontFamily: 'Baskervville SC, serif' }}>Nutrizen: Know Your Nutrition - Track Nutrients & Detect Calories</h1>
                <h2 className='md:text-lg text-sm my-4 font-mono text-white'>Bangkit Academy Capstone Project - Simbelmawa, Kemdikbud, Indonesia</h2>
                ...
                <p className='text-white text-lg md:text-xl text-justify' style={{ fontFamily: 'Baskervville SC, serif' }}>Furthermore, NutriZen offers personalized meal plans and reminders that cater to individual health goals, whether the objective is weight gain, loss, or maintenance. The app takes into account user&apos;s dietary preferences, ensuring that the suggested meals are aligned with their lifestyle and nutritional needs. This level of customization sets NutriZen apart from other nutrition apps that often focus solely on calorie counting without factoring in personal goals and food preferences. The result is a more holistic approach to healthy eating, providing users with a tailored guide to better nutrition.</p>

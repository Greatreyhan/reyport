    ...
    return (
        <>
            ...
            <div className='w-8/12 mx-auto'>
                ...
                {/* Title */}
                <h1 className='mt-8 text-5xl text-white' style={{ fontFamily: 'Baskervville SC, serif' }}>Automatic IoT-Based Tree Seedling Planter as a Solution to Accelerate Reforestation Rates in Support of the 2030 Sustainable Development Goals (SDGs)</h1>
                <h2 className='text-lg my-4 font-mono text-white'>PKM-KC 2022 PIMNAS & Funding Awardee - Simbelmawa, Kemdikbud, Indonesia                </h2>

    ...
    return (
        <>
            ...
            <div className='w-8/12 mx-auto'>
                ...
                {/* Title */}
                <h1 className='mt-8 text-5xl text-white' style={{ fontFamily: 'Baskervville SC, serif' }}>Sustainable Empowerment of Farmer Groups through Pitro Green System Technology in Efforts to Increase Crop Productivity in Pitrosari Village, Temanggung Regency.</h1>
                <h2 className='text-lg my-4 font-mono text-white'>PPK Ormawa Funding Awardee - Simbelmawa, Kemdikbud, Indonesia</h2>

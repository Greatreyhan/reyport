  ...
  const ListExperience: React.FC<ListExperienceProps> = ({title, position, place, desc1, desc2, period }) => {
    return (
        <div className="border-t border-opacity-25 border-slate-300 mt-4 flex items-center gap-x-10 py-4">
            <div className='rounded-full w-5/12 flex justify-center items-center h-52 relative'>
                <h4 className="text-3xl font-bold" style={{ fontFamily: 'Baskervville SC, serif' }}>{period}</h4>
            </div>

...
const Hero = () => {
  return (
    <div id="profile" className='bg-black mx-auto w-10/12 py-32 flex items-center gap-x-10 justify-center'>
      {/* Pict */}
      ...
      <div className='flex-1'>
        ...
        <a href="https://drive.google.com/file/d/1HWDMGB1ztSfXyZvFyNIErmDqq4uEgkie/view?usp=sharing" className='hover:underline underline-offset-2 mt-8 inline-flex items-center text-white-500 text-lg uppercase bg-white text-black px-8 py-1.5 font-semibold rounded-full'><span style={{ fontFamily: 'Baskervville SC, serif' }}>Download My CV</span><MdFileDownload className='ml-2' /></a>
      </div>
    </div>
  )
}
